...
public class WellAdapter extends RecyclerView.Adapter {
    ...
    private WellListner listner;

    public WellAdapter(Context context, List list) {
        mContext = context;
    ...
    public void setOnWellListner(WellListner listner) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            // TODO 如果查询到数据为空 则清空 显示 同时隐藏 查看大图
