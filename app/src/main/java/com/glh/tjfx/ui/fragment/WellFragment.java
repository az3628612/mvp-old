...
import com.glh.tjfx.presenter.impl.WellPresenterImpl;
 ...
 * 分井口统计
 */
public class WellFragment extends BaseFragment<IWellView, WellPresenterImpl> implements IWellView {
    ...
    public void initView(View view) {
        ...
        adapter = new WellAdapter(getActivity(), mList);
        adapter.setOnWellListner(new WellAdapter.WellListner() {
            @Override
    ...
    @Override
    protected WellPresenterImpl getPresenter() {
        return new WellPresenterImpl();
    }
